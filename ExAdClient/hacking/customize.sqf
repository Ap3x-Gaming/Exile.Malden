...
ExAd_HACKING_ALLOWED_HACKS = 2;					//SCALAR - Simultaneous hacks allowed.
...
ExAd_HACKING_FAILED_HACK = 0;					//SCALAR - 0-1 The possability for the hack to fail once finished.
