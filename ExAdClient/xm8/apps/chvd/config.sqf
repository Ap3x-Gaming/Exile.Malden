...
CHVD_maxView = 3000; 		//0-12000

CHVD_maxObj = 3000; 		//0-12000
...
[] spawn {
	...
	CHVD_maxView = if (isNil "CHVD_maxView") then {3000} else {CHVD_maxView};
	CHVD_maxObj = if (isNil "CHVD_maxObj") then {3000} else {CHVD_maxObj};
	...
	CHVD_footTerrain = if (CHVD_allowNoGrass) then {profileNamespace getVariable ["CHVD_footTerrain",35]} else {(profileNamespace getVariable ["CHVD_footTerrain",35]) min 48.99 max 3.125};
	CHVD_carTerrain = if (CHVD_allowNoGrass) then {profileNamespace getVariable ["CHVD_carTerrain",35]} else {(profileNamespace getVariable ["CHVD_carTerrain",35]) min 48.99 max 3.125};
	CHVD_airTerrain = if (CHVD_allowNoGrass) then {profileNamespace getVariable ["CHVD_airTerrain",35]} else {(profileNamespace getVariable ["CHVD_airTerrain",35]) min 48.99 max 3.125};
