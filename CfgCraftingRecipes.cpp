...
class CraftWoodDoubleGate: Exile_AbstractCraftingRecipe
{
	name = "Craft Wood Double Gate";
...
class RecycleMetalHedgehog: Exile_AbstractCraftingRecipe
{
...
class RecycleMetalLadder: Exile_AbstractCraftingRecipe
{
	name = "Recycle Metal Ladder";
	pictureItem = "Exile_Item_MetalLadderKit";
	requiredInteractionModelGroup = "WorkBench";
	returnedItems[] =
	{
...
class RecycleMetalLadderDouble: Exile_AbstractCraftingRecipe
{
	name = "Recycle Metal Ladder (Double Tall)";
	pictureItem = "Exile_Item_MetalLadderDoubleKit";
	requiredInteractionModelGroup = "WorkBench";
	returnedItems[] =
	{
...
class RecycleMetalPole: Exile_AbstractCraftingRecipe
{
	name = "Recycle Metalpole";
	pictureItem = "Exile_Item_MetalPole";
	requiresFire = 1;
	returnedItems[] = 
	{
...
class RecycleMetalBoard: Exile_AbstractCraftingRecipe
{
	name = "Recycle MetalBoard";
	pictureItem = "Exile_Item_MetalBoard";
	requiresFire = 1;
	returnedItems[] = 
	{
...
class RecycleWorkBench: Exile_AbstractCraftingRecipe
{
