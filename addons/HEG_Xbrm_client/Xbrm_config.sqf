...
Xbrm_doorC_chance = 0;											// Chance by percentage to successfully open concrete door
Xbrm_doorM_chance = 0;											// Chance by percentage to successfully open a metal door
Xbrm_door_chance = 0;											// Chance by percentage to successfully open a wooden door
Xbrm_defuse_chance = 60; 										// Chance by percentage to successfully defuse bomb

//TIMES
Xbrm_safe_time = 600; 											// Time in seconds to attempt safe opening. Default 10min (600 sec)
Xbrm_door_time = 600;											// Time in seconds to attempt opening a wooden door
Xbrm_doorM_time = 600;											// Time in seconds to attempt opening a metal door
Xbrm_doorC_time = 600;											// Time in seconds to attempt opening a concrete door
Xbrm_defuse_time = 600;          								// Time in seconds it takes to make a defusal attempt. Default 60						
...
//CLASSES
Xbrm_safe_trap = "Exile_Item_BreachingCharge_BigMomma";					// Explosive to be used for safe trapping. Default: Satchel Charge - "SatchelCharge_Remote_Mag"
...
Xbrm_no_trap = 			"You need a Breaching Charge BigMomma!";
