...
[
	"Connect to the TRG Gaming by Riggo.",
	"Check our discord https://discord.gg/MTvpBMdfd7",
	...
	"Any vehicle left inside the safezone will be unlocked at restart",
	"Not everyone that kills you is a hacker.",
	"ARMA 3 TRG Gaming by Riggo.",
	"Do not leave vehicles on exile base parts, at restart they will likely explode"
];
_tipText ctrlSetStructuredText parseText format["<t color='#47d247' size ='1.8 / (getResolution select 5)' valign='middle' align='right'>[ %1 ]</t>",_tipTextList];
