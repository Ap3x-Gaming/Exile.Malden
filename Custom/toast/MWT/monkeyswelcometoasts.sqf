...
_servername = "Ap3x Gaming Malden";
_serverclantag = "[Ap3x]";
_website = "https://discord.gg/DKyNb5W3hZ";
_discordLink = "https://discord.gg/DKyNb5W3hZ";
_donatelink = " ";
...
if ( alive player ) then {
	...
	<t size='22' font='PuristaMedium' color='%3'> %4 %5!</t>",_generaltitlecolor, name player, _generaltextcolor, _servername, worldName], _generaltoastcolor] call ExileClient_gui_toaster_addToast; sleep 15;
	
	[format ["<t size='30' font='OrbitronMedium' color='%1'>Join our Discord! %2!</t><br /> 
	<t size='22' font='PuristaMedium' color='%3'>Ap3x Gaming %4 %5!</t>",_generaltitlecolor, name player, _generaltextcolor, _servername, worldName], _generaltoastcolor] call ExileClient_gui_toaster_addToast; sleep 15;
	
	[format ["<t size='30' font='OrbitronMedium' color='%1'>Server Rules!</t><br />
	<t size='22' font='PuristaMedium' color='%2'>Read Rules on discord! Ignorance is no excuse!</t>", _importanttitlecolor, _importanttextcolor], _importanttoastcolor] call ExileClient_gui_toaster_addToast; sleep 30;
	
	[format ["<t size='30' font='OrbitronMedium' color='%1'>Server Information!</t><br />
	<t size='22' font='PuristaMedium' color='%2'>All information you might like to know is on our Discord...</t>", _importanttitlecolor, _importanttextcolor], _importanttoastcolor] call ExileClient_gui_toaster_addToast; sleep 50;
