				...
				{
					{
						...
						if (getMarkerType _marker isEqualTo _type) then
						{
							...
							{
								deleteVehicle _projectile;
								["ErrorTitleAndText", ["Explosive Deleted", "You can not place a explosive this close to a Trader!"]] call ExileClient_gui_toaster_addTemplateToast;
							};
						};
					} forEach getArray (missionConfigFile >> "AntiMinesNearSafeZone_Config" >> "MarkersToBlockNear");
				};
