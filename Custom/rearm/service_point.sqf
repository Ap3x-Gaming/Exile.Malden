...
_servicePointClasses = ["Land_A_FuelStation_Feed",
...
_maxDistance = 60; // maximum distance from a service point for the options to be shown
_costsFree = "FREE SERVICE"; // text for no costs
_message = "-- VEHICLE SERVICE POINT --"; // message to be shown when in range of a service point (set to "" to disable)
_actionColour = "#1BFF00"; //the colour of the scroll action Blue: "#0096ff" limegreen is #1BFF00
 
//====================== repair settings
_repair_enable = enable; // enable or disable the repair option
