...
else
{
    ...
    if (!(isNil "Yeet") && (_weaponPanelType == 1 || _weaponPanelType == 2)) then {
            _weaponPanelControl ctrlSetPosition [((safezoneX + safezoneW) - 256 * pixelW - 60 * pixelW),((safezoneY + safezoneH) - 128 * pixelH - 60 * pixelH),(256 * pixelW),(128 * pixelH)];
            _weaponPanelControl ctrlCommit 0;
            Yeet = nil;
    };
    if ((isNil "Yeet") && (_weaponPanelType isEqualTo 3)) then {
            _weaponPanelControl ctrlSetPosition [((safezoneX + safezoneW) - 256 * pixelW - 60 * pixelW),(0.7725 * safezoneH + safezoneY),(256 * pixelW),(128 * pixelH)];
            _weaponPanelControl ctrlCommit 0;
            Yeet = 1;
    };
};