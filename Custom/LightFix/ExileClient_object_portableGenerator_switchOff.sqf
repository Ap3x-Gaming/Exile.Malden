...
_floodLights = nearestObjects [_portableGenerator, ["Exile_Construction_FloodLight_Static","Land_PortableLight_double_F","Land_LampAirport_F","Land_LampHalogen_F","Land_LampShabby_F","Land_LampStreet_F"], 150];
